...
def lambda_handler(event, context):
    ...
    push_list = list(filter(
        judge_output_dbd_official, twitter_api.user_timeline(user_id='DeadbyBHVR_JP', tweet_mode='extended', exclude_replies=True, include_rts=False)
    ))
    ...
    push_list += list(filter(
        judge_output_ruby_nea, twitter_api.user_timeline(user_id='Ruby_Nea_', tweet_mode='extended', exclude_replies=True, include_rts=False)
    ))
